...
@Component({
    selector: 'app-email-processing-home',
    templateUrl: './email-processing-home.component.html',
    styleUrls: ['./email-processing-home.component.scss']
})
export class EmailProcessingHomeComponent implements OnInit {
