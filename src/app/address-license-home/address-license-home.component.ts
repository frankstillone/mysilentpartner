...
@Component({
    selector: 'app-address-license-home',
    templateUrl: './address-license-home.component.html',
    styleUrls: ['./address-license-home.component.scss']
})
export class AddressLicenseHomeComponent implements OnInit {
